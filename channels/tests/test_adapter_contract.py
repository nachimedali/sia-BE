...
# -----------------------------------------------------------------------------
# Measurement is not on this port
# -----------------------------------------------------------------------------
# `fetch_metrics`, `fetch_comments` and `fetch_account_stats` used to live here
# and moved to `analytics.providers` in P0-30. Their contract tests moved with
# them, to `analytics/tests/test_metrics_provider.py`. The structural assertion
# that they cannot come back is `analytics/tests/test_port_separation.py`.
